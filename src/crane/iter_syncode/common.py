...
HF_CACHE = os.environ['HF_CACHE'] if 'HF_CACHE' in os.environ else 'iter_cache/'
SYNCODE_CACHE = os.environ['ITER_SYNCODE_CACHE'] if 'ITER_SYNCODE_CACHE' in os.environ else 'iter_cache/'
