...
class SQLEval:
    ...
    def compute_accuracy(results_jsonl, predict_file):
        from crane.iter_syncode.utils.sql_spider_eval.evaluation import evaluate

        # Get current dir path
        current_dir = os.path.dirname(os.path.realpath(__file__))

        # Set paths (currently hardcoded) wull clean it up later TODO(debangshu)
        gold_file = f"/home/debangshu/LLM-COT/src/itergen/iter_syncode/iter_syncode/utils/sql_spider_eval/evaluation_examples/gold_example.txt"
        tables = f"/home/debangshu/LLM-COT/src/itergen/iter_syncode/iter_syncode/utils/sql_spider_eval/evaluation_examples/examples/tables.json"
        databases = f"/home/debangshu/LLM-COT/src/itergen/iter_syncode/iter_syncode/utils/sql_spider_eval/databases"
